...
- **API GraphQL:** [Link al repositorio de la API](#)
- **Frontend (Next.js):** [Link al repositorio del frontend](#)
- **Docker:** [Link al Dockerfile](#)
- **Portafolio:** [Link al portafolio actualizado](#)
